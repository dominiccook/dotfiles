...
inoremap ;nb @book{(<>),<cr><tab>title="(<>)",<cr>author="(<>)",<cr>publisher="(<>)"<cr>}<esc>5k
...
autocmd FileType tex inoremap ;pr <CR>${_\blacksquare}$<CR><CR>
autocmd FileType tex inoremap ;di $d_{(<>)}((<>), (<>)) < (<>)$ (<>)<Esc>2T{
autocmd FileType tex inoremap ;fa \mathbb{(<>)}<Esc>T{
autocmd FileType tex inoremap ;dr '((<>)) (<>)<esc>T'hi
...
autocmd FileType tex inoremap ;< \langle<Space>(<>)<Space>\rangle<Space>(<>)<Esc>2T\i
...
" --- bindings for THEO 315 posts
autocmd FileType tex inoremap ;np \section[newspost]{(<>)}<cr>(<>)<cr>\begin{enumerate}<cr>\item<space>(<>)<cr>\item<space>(<>)<cr>\end{enumerate}<cr><cr>(<>)<esc>8k
